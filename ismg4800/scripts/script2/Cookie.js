/**
 * Dawn: This is a nice bit of code! Truly allowed me to clean up the 
 * shop cart functions.... 
 *
 **/
...
function Cookie(name, duration, path, domain, secure)
{
   ...
   {
     return getValue(); //added this
   }
      
   this.expire = function()  //rewrote the expire function. This is shorter!
   {
